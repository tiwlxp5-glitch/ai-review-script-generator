  ...
  return (
    <div className="flex items-center justify-center min-h-[calc(100vh-12rem)] px-4">
      <div className="w-full max-w-md text-center">
        <div className="glass-card rounded-3xl p-8 sm:p-10 border border-purple-500/30 shadow-2xl bg-slate-950/90 space-y-6 relative overflow-hidden">
          ...
          <div className="relative inline-flex items-center justify-center">
            <div className="w-20 h-20 rounded-3xl bg-gradient-to-tr from-emerald-500 via-purple-600 to-indigo-600 shadow-xl shadow-emerald-500/20 flex items-center justify-center text-white ring-4 ring-emerald-500/20 animate-pulse">
          ...
          <div className="pt-4 space-y-4">
            <Link
              href="/dashboard"
              className="w-full py-4 px-6 rounded-2xl text-base font-bold text-white bg-gradient-to-r from-purple-600 via-indigo-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 shadow-xl shadow-purple-600/30 flex items-center justify-center space-x-2 transition group"
            >
