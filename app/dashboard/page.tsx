...
export default function DashboardPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto py-4 sm:py-6 px-3.5 sm:px-6 lg:px-8 space-y-6">
      {/* Desktop Split-Screen Grid Layout (`lg:grid-cols-12`) */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-start">

        {/* LEFT COLUMN: Controls & Input Form (`lg:col-span-5 space-y-6`) */}
        <div className="lg:col-span-5 space-y-6">

          {/* Hero Header Section */}
          <div className="text-left space-y-3 sm:space-y-4">
            <div className="flex items-center space-x-3">
              <div className="inline-flex items-center justify-center p-2.5 sm:p-3 rounded-xl sm:rounded-2xl bg-gradient-to-tr from-purple-600 via-indigo-600 to-pink-500 shadow-xl shadow-purple-500/25 ring-1 ring-purple-400/30 shrink-0">
                <Pencil className="w-5 h-5 sm:w-6 sm:h-6 text-white fill-white/20" />
              </div>
              <div>
                <h1 className="text-xl sm:text-3xl font-black tracking-tight text-slate-900 dark:text-white leading-snug sm:leading-tight">
                  AI คิดสคริปต์{" "}
                ...
                <p className="text-xs sm:text-sm font-bold text-slate-700 dark:text-slate-200">
                  TikTok Studio + B-Roll + Teleprompter
                </p>
              </div>
            </div>
            ...
            {usage && usage.user_type !== "guest" && (
              <div className="pt-1">
                {usage.user_type === "admin" ? (
                  ...
                  <span className="inline-flex items-center space-x-1.5 px-3.5 py-1.5 rounded-full bg-amber-500/15 border border-amber-500/40 text-amber-700 dark:text-amber-300 text-xs font-bold shadow-md shadow-amber-500/10">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    <span className="inline-flex items-center space-x-1.5 px-3 py-1.5 rounded-full bg-indigo-500/15 border border-indigo-500/30 text-indigo-700 dark:text-indigo-300 text-xs font-semibold">
                    ...
                    <Link
                      href="/history"
                      className="px-3 py-1.5 rounded-full bg-slate-100 dark:bg-slate-900/90 hover:bg-slate-200 dark:hover:bg-slate-900 border border-slate-300 dark:border-slate-800 text-slate-700 dark:text-slate-300 text-xs font-semibold transition flex items-center space-x-1 cursor-pointer"
                    >
                      <History className="w-3.5 h-3.5 text-purple-500 dark:text-purple-400 shrink-0" />
                      <span>ประวัติ</span>
                    </Link>
                    <button
                      onClick={() => openUpgradeModal("pro")}
                      className="px-3 py-1.5 rounded-full bg-gradient-to-r from-amber-500 to-yellow-500 hover:from-amber-400 hover:to-yellow-400 text-slate-950 text-xs font-bold shadow-md shadow-amber-500/20 transition flex items-center space-x-1 cursor-pointer"
                    >
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    <span className="inline-flex items-center space-x-1.5 px-3 py-1.5 rounded-full bg-purple-500/10 border border-purple-500/30 text-purple-700 dark:text-purple-300 text-xs font-medium">
                      <BarChart2 className="w-3.5 h-3.5 text-purple-500 dark:text-purple-400 shrink-0" />
                      <span>
                        ฟรี:{" "}
                        <strong className="text-slate-900 dark:text-white">
                          {usage.remaining}/{usage.limit}
                    ...
                    <button
                      onClick={() => openUpgradeModal("pro")}
                      className="px-3 py-1.5 rounded-full bg-gradient-to-r from-amber-500 to-yellow-500 hover:from-amber-400 hover:to-yellow-400 text-slate-950 text-xs font-black shadow-md shadow-amber-500/20 transition flex items-center space-x-1 cursor-pointer"
                    >
                      <Crown className="w-3.5 h-3.5 fill-slate-950 shrink-0" />
                      <span>Pro (199.-)</span>
                    </button>
          ...
          {usage && usage.user_type !== "admin" && usage.user_type !== "guest" && usage.remaining !== "unlimited" && typeof usage.remaining === "number" && usage.remaining <= 5 && (
            <div className="p-3.5 sm:p-4 rounded-2xl bg-amber-500/10 border border-amber-500/30 text-amber-800 dark:text-amber-300 text-xs sm:text-sm font-semibold flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 sm:gap-3 animate-in fade-in duration-200">
              <div className="flex items-start sm:items-center space-x-2.5 min-w-0">
                <AlertCircle className="w-4 h-4 sm:w-5 sm:h-5 text-amber-500 dark:text-amber-400 shrink-0 mt-0.5 sm:mt-0" />
          ...
          {/* Success Banner */}
          {successBanner && (
            <div className="relative p-3.5 sm:p-5 pr-9 rounded-2xl bg-gradient-to-r from-amber-500/20 via-yellow-500/15 to-amber-500/20 border border-amber-500/50 text-amber-900 dark:text-amber-100 text-xs sm:text-sm font-semibold shadow-2xl shadow-amber-500/15 animate-in fade-in zoom-in-95 backdrop-blur-md">
              <button
                onClick={() => setSuccessBanner(null)}
                className="absolute top-2.5 right-2.5 text-amber-600 dark:text-amber-400 hover:text-amber-800 dark:hover:text-amber-200 p-1.5 rounded-xl hover:bg-amber-500/20 transition cursor-pointer"
              >
                ✕
              </button>
              <div className="flex items-start space-x-3">
                ...
                <div className="space-y-1 min-w-0 pr-1">
                  <div className="text-[11px] sm:text-xs font-black uppercase tracking-wider text-amber-600 dark:text-amber-400 flex items-center space-x-1">
                    <Sparkles className="w-3.5 h-3.5 text-amber-500 dark:text-amber-300 fill-amber-300 animate-pulse" />
                    <span>การชำระเงินสำเร็จ 100%</span>
                  </div>
                  <p className="text-xs sm:text-base font-bold text-slate-800 dark:text-slate-100 leading-relaxed">
                    ยินดีด้วย! บัญชีของคุณถูกอัปเกรดเป็น{" "}
                    <strong className="text-amber-600 dark:text-amber-300 font-extrabold underline decoration-amber-400 decoration-2 underline-offset-2">
          ...
          {/* Error Banner */}
          {error && (
            <div className="p-4 rounded-2xl bg-rose-500/10 border border-rose-500/30 text-rose-800 dark:text-rose-300 text-sm space-y-2">
              <div className="flex items-start space-x-3">
          ...
          {/* Main Control Panel Form Card */}
          <div className="bg-white/70 dark:bg-slate-950/80 backdrop-blur-xl border border-slate-200/80 dark:border-slate-800/80 shadow-xl dark:shadow-2xl rounded-2xl sm:rounded-3xl p-4 sm:p-6 space-y-4 sm:space-y-5">
            <form onSubmit={handleGenerate} className="space-y-4 sm:space-y-5">
              ...
              <div className="space-y-2">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1.5">
                  <label className="block text-sm font-semibold text-purple-700 dark:text-purple-300">
                    ...
                    <span className="text-purple-600 dark:text-purple-400 font-normal">* จำเป็น</span>
                  </label>

                  <button
                    type="button"
                    onClick={() => setIsAnalyzerModalOpen(true)}
                    className="px-3 py-1.5 rounded-xl bg-gradient-to-r from-purple-500/20 via-pink-500/20 to-amber-500/20 hover:from-purple-500/30 hover:to-amber-500/30 border border-purple-500/40 text-purple-800 dark:text-purple-200 text-xs font-bold transition flex items-center justify-center space-x-1.5 shrink-0 cursor-pointer shadow-sm min-h-[38px]"
                  >
                    <Sparkles className="w-3.5 h-3.5 text-amber-500 dark:text-amber-400 fill-amber-400 animate-pulse shrink-0" />
                    <span>AI วิเคราะห์สินค้า ✨</span>
                  </button>
                </div>
                <input
                  type="text"
                  ...
                  className="w-full px-4 py-3 text-sm sm:text-base rounded-2xl text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 border border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/90 focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all min-h-[48px]"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-3 gap-2">
                  <button
                    ...
                    className={`p-2.5 rounded-2xl border text-center transition-all cursor-pointer min-h-[48px] flex flex-col items-center justify-center ${
                      scriptLength === "short"
                        ? "bg-purple-600/25 border-purple-500 text-purple-900 dark:text-purple-200 ring-2 ring-purple-500/40 font-bold"
                        : "bg-slate-100/80 dark:bg-slate-900/80 border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:border-purple-500/40"
                    }`}
                  >
                    <div className="text-xs sm:text-sm font-bold text-inherit">⚡ สั้น</div>
                    <div className="text-[10px] sm:text-[11px] text-inherit opacity-80 mt-0.5">~15-30s</div>
                  </button>
                  ...
                  >
                    <div className="text-xs sm:text-sm font-bold text-inherit">🎬 ปกติ</div>
                    <div className="text-[10px] sm:text-[11px] text-inherit opacity-80 mt-0.5">~30-60s</div>
                  </button>
                  ...
                  >
                    <div className="text-xs sm:text-sm font-bold text-inherit">📖 ยาว</div>
                    <div className="text-[10px] sm:text-[11px] text-inherit opacity-80 mt-0.5 whitespace-nowrap">~60-90+s</div>
                  </button>
                </div>
              </div>
              ...
              <div className="space-y-3">
                {!isProOrAdmin && (
                  <div className="p-3 rounded-2xl bg-white/80 dark:bg-slate-900/90 border border-amber-500/35 shadow-lg shadow-amber-500/5 flex flex-col xs:flex-row items-start xs:items-center justify-between gap-2.5">
                    <div className="flex items-center space-x-2.5 min-w-0">
                      <div className="w-7 h-7 rounded-xl bg-amber-500/15 border border-amber-500/30 flex items-center justify-center text-amber-500 dark:text-amber-400 shrink-0">
                        <Sparkles className="w-3.5 h-3.5 text-amber-500 dark:text-amber-400 fill-amber-400 animate-pulse" />
                      </div>
                      <div className="min-w-0">
                        <div className="text-xs font-bold text-amber-800 dark:text-amber-200 truncate">
                          {isPlusUser
                            ? "สเปกสมอง AI (Plus Plan 🔵)"
                            : "สมอง AI ฟรี vs Pro"}
                        </div>
                      </div>
                    </div>
                    ...
                    <button
                      ...
                      className="px-2.5 py-1 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 text-xs font-black shadow transition flex items-center space-x-1 shrink-0 cursor-pointer"
                    >
                      <span>ดูสมอง AI ⚡</span>
                    </button>
                  </div>
                  ...
                  <span className="text-xs font-semibold text-amber-600 dark:text-amber-400 flex items-center space-x-1">
                    ...
                    <span>
                      {isProOrAdmin
                        ? "10 โทนระดับ Pro"
                        : isPlusUser
                        ? "5 โทน Plus (อัปเกรด Pro รับ 10 โทน)"
                        : "ฟรี 2 โทน (อัปเกรดรับ 10 โทน)"}
                    </span>
                  </span>
                </div>
                    ...
                    return (
                      <button
                        ...
                        className={`p-3 rounded-2xl border text-left transition-all relative overflow-hidden group cursor-pointer ${
                          isSelected
                            ? "bg-purple-600/25 border-purple-500 text-purple-900 dark:text-purple-200 ring-2 ring-purple-500/40 shadow-lg shadow-purple-500/10"
                            : isAllowed
                            ? "bg-slate-100/80 dark:bg-slate-900/80 border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-300 hover:border-purple-500/50 hover:bg-slate-200/60 dark:hover:bg-slate-900"
                            : "bg-slate-100/40 dark:bg-slate-950/60 border-slate-200/80 dark:border-slate-800/80 text-slate-400 dark:text-slate-500 opacity-75 hover:border-amber-500/40"
                        }`}
                      >
                        <div className="flex items-start justify-between gap-2">
                          <p className="text-xs sm:text-sm font-bold text-inherit flex items-center space-x-1.5">
                        ...
                        <p className="text-xs font-semibold text-purple-700 dark:text-purple-300/90 pt-1">
                          {tone.desc}
                        </p>
                        <p className="text-[11px] text-slate-500 dark:text-slate-400 pt-1 leading-normal border-t border-slate-200/60 dark:border-slate-800/50 mt-2">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full px-4 py-3.5 text-sm sm:text-base rounded-2xl text-slate-900 dark:text-slate-100 placeholder-slate-400 dark:placeholder-slate-500 border border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-900/90 focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all min-h-[48px]"
                />
              </div>
          ...
          {loading && (
            <div className="bg-white/90 dark:bg-slate-950/95 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-4 sm:p-6 border border-purple-500/40 shadow-2xl space-y-3 sm:space-y-4 animate-in fade-in duration-200">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 sm:gap-3">
                <div className="flex items-start space-x-3 min-w-0">
                  <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-purple-500/15 border border-purple-500/30 flex items-center justify-center text-purple-600 dark:text-purple-300 shrink-0 mt-0.5 sm:mt-0">
                ...
                {/* Countdown Badge */}
                <div className="self-start sm:self-auto px-3 py-1.5 rounded-xl bg-purple-500/10 border border-purple-500/30 text-purple-700 dark:text-purple-300 text-xs font-black flex items-center space-x-1.5 shrink-0 shadow-sm">
                  <Clock className="w-3.5 h-3.5 text-amber-500 dark:text-amber-400 animate-spin" />
        ...
        {/* RIGHT COLUMN: Output Display & Tools Panel (`lg:col-span-7 space-y-6`) */}
        <div className="lg:col-span-7 space-y-6">

          {/* If generatedScript exists, show Output Display Card */}
          {generatedScript ? (
            <div className="bg-white/70 dark:bg-slate-950/90 backdrop-blur-xl border border-slate-200/80 dark:border-slate-800/80 shadow-xl dark:shadow-2xl rounded-2xl sm:rounded-3xl p-4 sm:p-6 space-y-5 sm:space-y-6">
              
              {/* Header Bar with Action Controls */}
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between pb-3 sm:pb-4 border-b border-slate-200/80 dark:border-slate-800/80 gap-3">
                <div className="flex items-center space-x-3">
                ...
                <div className="flex items-center gap-2 w-full sm:w-auto justify-end">
                  ...
                  >
                    ...
                    {!isProOrAdmin && (
                      <span className="px-1.5 py-0.2 rounded bg-amber-500/20 text-amber-700 dark:text-amber-300 text-[10px] shrink-0">
                        PRO
                      </span>
                    )}
                  </button>
                  ...
                  <button
                    onClick={handleReset}
                    className="w-11 h-11 rounded-xl bg-slate-100 dark:bg-slate-900 hover:bg-slate-200 dark:hover:bg-slate-800 text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200 border border-slate-200 dark:border-slate-800 transition cursor-pointer shrink-0 flex items-center justify-center"
                    title="เริ่มใหม่"
                    aria-label="Reset"
                  >
              ...
              <div className="flex items-center space-x-1.5 sm:space-x-2 border-b border-slate-200/80 dark:border-slate-800/80 pb-2 text-xs font-bold overflow-x-auto whitespace-nowrap scrollbar-none">
                <button
                ...
                >
                  <Hash className="w-4 h-4 text-amber-500 dark:text-amber-400 shrink-0" />
              ...
              {/* Loading Animation inside card */}
              {loading ? (
                <div className="py-16 flex flex-col items-center justify-center space-y-4 text-center">
                  <div className="relative">
                    <div className="w-16 h-16 rounded-full border-4 border-purple-500/20 border-t-purple-500 animate-spin" />
                    <Sparkles className="w-6 h-6 text-purple-500 dark:text-purple-400 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 animate-pulse" />
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  {activeTab === "script" && (
                    <div className="space-y-4">
                      ...
                      <div className="flex flex-wrap items-center justify-between gap-2 pb-1 border-b border-slate-200/80 dark:border-slate-800/60">
                        <div className="flex items-center space-x-1.5 text-xs">
                          <button
                            ...
                            className={`px-3 py-1.5 rounded-xl flex items-center space-x-1.5 transition cursor-pointer ${
                              scriptMode === "original"
                                ? "bg-purple-600/25 text-purple-700 dark:text-purple-300 border border-purple-500/40 font-bold shadow"
                          ...
                          <button
                            ...
                            className={`px-3 py-1.5 rounded-xl flex items-center space-x-1.5 transition cursor-pointer ${
                              scriptMode === "custom"
                                ? "bg-amber-500/25 text-amber-700 dark:text-amber-300 border border-amber-500/40 font-bold shadow"
                                : "text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-900"
                            }`}
                          >
                        ...
                        {scriptMode === "original" ? (
                          <button
                            ...
                            className="px-3 py-1.5 rounded-xl bg-amber-500/15 hover:bg-amber-500/25 text-amber-700 dark:text-amber-300 border border-amber-500/30 text-xs font-semibold transition flex items-center space-x-1 cursor-pointer"
                          >
                            <Pencil className="w-3.5 h-3.5" />
                          ...
                          <button
                            ...
                            className="px-3 py-1.5 rounded-xl bg-slate-100 dark:bg-slate-900 hover:bg-slate-200 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-800 text-xs font-medium transition flex items-center space-x-1 cursor-pointer"
                          >
                      ...
                      {isProOrAdmin ? (
                        <div className="p-4 sm:p-5 rounded-2xl bg-white/80 dark:bg-slate-900/95 border border-amber-500/40 space-y-4 shadow-xl">
                          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-amber-500/20 pb-3">
                            <div className="flex items-center space-x-2.5">
                              <div className="w-8 h-8 rounded-xl bg-amber-500/20 text-amber-700 dark:text-amber-300 border border-amber-500/40 flex items-center justify-center font-black text-xs shrink-0 shadow-sm">
                                PRO
                              </div>
                              <div>
                                <h3 className="text-xs sm:text-sm font-extrabold text-amber-800 dark:text-amber-300 flex items-center space-x-1.5">
                          ...
                          <div className="grid grid-cols-1 xl:grid-cols-3 gap-3.5">
                            {/* Hook A */}
                            <div className="p-4 rounded-xl bg-emerald-500/5 dark:bg-gradient-to-b dark:from-emerald-950/40 dark:to-slate-950 border border-emerald-500/40 space-y-2.5 flex flex-col justify-between shadow-md">
                              <div className="space-y-2">
                                <div className="px-2.5 py-1 rounded-lg bg-emerald-500/20 text-emerald-800 dark:text-emerald-300 border border-emerald-500/40 text-xs font-black inline-block">
                                  👁️ Hook A: สายเน้นภาพ & Action
                                </div>
                                <p className="text-[11px] text-emerald-800 dark:text-emerald-200/80 font-medium leading-relaxed">
                                  💡 โชว์ช็อตสินค้า หรือการกระทำตื่นเต้น 3 วินาทีแรก เพื่อหยุดนิ้วคนดูบนฟีด
                                </p>
                                <div className="p-3 rounded-xl bg-white/90 dark:bg-slate-900/90 border border-emerald-500/30 text-xs text-slate-900 dark:text-slate-100 font-semibold leading-relaxed selection:bg-emerald-500/30 min-h-[60px]">
                            ...
                            {/* Hook B */}
                            <div className="p-4 rounded-xl bg-indigo-500/5 dark:bg-gradient-to-b dark:from-indigo-950/40 dark:to-slate-950 border border-indigo-500/40 space-y-2.5 flex flex-col justify-between shadow-md">
                              <div className="space-y-2">
                                <div className="px-2.5 py-1 rounded-lg bg-indigo-500/20 text-indigo-800 dark:text-indigo-300 border border-indigo-500/40 text-xs font-black inline-block">
                                  🗣️ Hook B: สายเน้นสะกิดแผลจี้ปัญหา
                                </div>
                                <p className="text-[11px] text-indigo-800 dark:text-indigo-200/80 font-medium leading-relaxed">
                                  💡 ตั้งคำถามแทงใจดำ ชี้จุดเจ็บเรื่องปัญหาที่กลุ่มเป้าหมายกำลังเดือดร้อนอยู่
                                </p>
                                <div className="p-3 rounded-xl bg-white/90 dark:bg-slate-900/90 border border-indigo-500/30 text-xs text-slate-900 dark:text-slate-100 font-semibold leading-relaxed selection:bg-indigo-500/30 min-h-[60px]">
                            ...
                            {/* Hook C */}
                            <div className="p-4 rounded-xl bg-amber-500/5 dark:bg-gradient-to-b dark:from-amber-950/40 dark:to-slate-950 border border-amber-500/40 space-y-2.5 flex flex-col justify-between shadow-md">
                              <div className="space-y-2">
                                <div className="px-2.5 py-1 rounded-lg bg-amber-500/20 text-amber-800 dark:text-amber-300 border border-amber-500/40 text-xs font-black inline-block">
                                ...
                                <div className="p-3 rounded-xl bg-white/90 dark:bg-slate-900/90 border border-amber-500/30 text-xs text-slate-900 dark:text-slate-100 font-semibold leading-relaxed selection:bg-amber-500/30 min-h-[60px]">
                        ...
                        <div className="p-4 rounded-2xl bg-gradient-to-r from-amber-500/15 via-purple-500/15 to-indigo-500/15 border border-amber-500/30 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs">
                          <div className="space-y-1">
                            <p className="font-bold text-amber-800 dark:text-amber-300 flex items-center space-x-1.5">
                              <Crown className="w-4 h-4 text-amber-500 dark:text-amber-400 fill-amber-400 shrink-0" />
                      ...
                      {scriptMode === "original" ? (
                        <div className="p-4 xs:p-5 sm:p-6 rounded-2xl bg-slate-50/90 dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-slate-100 text-sm sm:text-base md:text-lg leading-relaxed whitespace-pre-wrap break-words font-sans selection:bg-purple-500/30">
                          {generatedScript}
                        </div>
                      ) : (
                        <div className="space-y-2">
                          <textarea
                            ...
                            rows={10}
                            className="w-full p-4 xs:p-5 sm:p-6 rounded-2xl bg-white/95 dark:bg-slate-900/95 border border-amber-500/40 text-slate-900 dark:text-amber-100 text-sm sm:text-base md:text-lg leading-relaxed font-sans focus:outline-none focus:ring-2 focus:ring-amber-500/30 selection:bg-amber-500/30 transition-all resize-y break-words"
                          />
                          <p className="text-[11px] text-amber-700 dark:text-amber-300/80 italic">
                            💡 ข้อความที่คุณแก้ไขตรงนี้ จะถูกส่งต่อไปแสดงบนเครื่องอ่านบท (Teleprompter) ให้อัตโนมัติ
                          </p>
                        </div>
                      )}

                      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs text-slate-500 dark:text-slate-400 pt-2">
                        <div className="flex items-center space-x-4">
                          <span>
                            จำนวนคำ: <strong className="text-slate-900 dark:text-slate-200">{wordCount}</strong> คำ
                          </span>
                          <span>
                            ตัวอักษร: <strong className="text-slate-900 dark:text-slate-200">{charCount}</strong> ตัว
                          </span>
                        </div>
                        <button
                  ...
                  {activeTab === "shotlist" && (
                    <div className="space-y-4">
                      {!isProOrAdmin ? (
                        <div className="relative rounded-2xl overflow-hidden border border-amber-500/30 bg-white/90 dark:bg-slate-950/90 p-1 min-h-[280px] flex flex-col justify-center">
                          {/* Lock Banner Overlay */}
                          <div className="absolute inset-0 z-20 flex flex-col items-center justify-center p-4 sm:p-6 bg-white/85 dark:bg-slate-950/85 backdrop-blur-md text-center space-y-3">
                            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-amber-500/20 text-amber-600 dark:text-amber-400 flex items-center justify-center border border-amber-500/40 shadow-lg shadow-amber-500/10">
                            ...
                            <div className="space-y-1 max-w-md">
                              ...
                              <p className="text-[11px] sm:text-xs text-amber-700 dark:text-amber-300 font-bold leading-relaxed">
                          ...
                          <div className="overflow-x-auto filter blur-md select-none pointer-events-none opacity-20 p-2 hidden sm:block">
                            <table className="w-full text-left text-xs sm:text-sm">
                              <thead className="bg-slate-100 dark:bg-slate-900 text-purple-700 dark:text-purple-300 font-bold border-b border-slate-200 dark:border-slate-800">
                                <tr>
                              ...
                              <tbody className="divide-y divide-slate-200 dark:divide-slate-800 bg-white dark:bg-slate-950 text-slate-800 dark:text-slate-200">
                                <tr>
                                  <td className="p-3 font-mono text-amber-600 dark:text-amber-400 font-bold">0-3s</td>
                                  ...
                                  <td className="p-3 text-emerald-600 dark:text-emerald-300 font-semibold">หยุดดูคลิปนี้ก่อน 😱</td>
                                </tr>
                                <tr>
                                  <td className="p-3 font-mono text-amber-600 dark:text-amber-400 font-bold">3-7s</td>
                                  ...
                                  <td className="p-3 text-emerald-600 dark:text-emerald-300 font-semibold">เห็นผลใน 5 วินาที ✨</td>
                                </tr>
                                <tr>
                                  <td className="p-3 font-mono text-amber-600 dark:text-amber-400 font-bold">7-15s</td>
                                  ...
                                  <td className="p-3 text-emerald-600 dark:text-emerald-300 font-semibold">กดตะกร้าเหลืองซ้ายล่าง 🛒</td>
                                </tr>
                              </tbody>
                            </table>
                          </div>
                        ...
                        shotList.length > 0 ? (
                          <div>
                            ...
                            <div className="space-y-3 sm:hidden max-h-80 overflow-y-auto pr-1">
                              {shotList.map((item, idx) => (
                                <div key={idx} className="p-3.5 rounded-xl bg-white/90 dark:bg-slate-950/90 border border-slate-200 dark:border-slate-800 space-y-2 text-xs">
                                  <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800/80 pb-1.5">
                                    <span className="font-mono text-amber-600 dark:text-amber-400 font-bold px-2 py-0.5 rounded bg-amber-500/10 border border-amber-500/20 text-[11px] flex items-center space-x-1">
                                      <Clock className="w-3 h-3 text-amber-500 dark:text-amber-400" />
                                      <span>{item.time}</span>
                                    </span>
                                    <span className="text-emerald-700 dark:text-emerald-300 font-bold text-[11px] truncate max-w-[180px] flex items-center space-x-1">
                                      <Pin className="w-3 h-3 text-emerald-500 dark:text-emerald-400 shrink-0" />
                                  ...
                                  <div className="space-y-1.5 text-slate-800 dark:text-slate-200">
                                    <p className="leading-relaxed flex items-start space-x-1.5">
                                      <Video className="w-3.5 h-3.5 text-purple-600 dark:text-purple-400 shrink-0 mt-0.5" />
                                      <span><strong className="text-purple-700 dark:text-purple-300 font-semibold">ภาพ B-Roll:</strong> {item.visual}</span>
                                    </p>
                                    <p className="leading-relaxed text-slate-700 dark:text-slate-300 flex items-start space-x-1.5">
                                      <Mic className="w-3.5 h-3.5 text-indigo-600 dark:text-indigo-400 shrink-0 mt-0.5" />
                                      <span><strong className="text-indigo-700 dark:text-indigo-300 font-semibold">เสียงพูด:</strong> {item.audio}</span>
                                    </p>
                                  </div>
                                </div>
                              ))}
                            ...
                            <div className="hidden sm:block overflow-x-auto rounded-2xl border border-slate-200 dark:border-slate-800 max-h-96 overflow-y-auto">
                              <table className="w-full min-w-full text-left text-xs sm:text-sm">
                                <thead className="bg-slate-100/90 dark:bg-slate-900/90 text-purple-700 dark:text-purple-300 font-bold border-b border-slate-200 dark:border-slate-800 sticky top-0">
                                  <tr>
                                    <th className="p-3 sm:p-4 w-20 whitespace-nowrap">เวลา</th>
                                    <th className="p-3 sm:p-4 w-2/5">ภาพที่ต้องถ่าย (B-Roll)</th>
                                    <th className="p-3 sm:p-4 w-2/5">เสียงพูด</th>
                                    <th className="p-3 sm:p-4 w-1/5">ขึ้นซับกลางจอ</th>
                                  </tr>
                                </thead>
                                <tbody className="divide-y divide-slate-200 dark:divide-slate-800/60 bg-white/60 dark:bg-slate-950/60 text-slate-800 dark:text-slate-200">
                                  {shotList.map((item, idx) => (
                                    <tr key={idx} className="hover:bg-slate-100/50 dark:hover:bg-slate-900/50 transition">
                                      <td className="p-3 sm:p-4 font-mono text-amber-600 dark:text-amber-400 font-bold whitespace-nowrap">
                                        {item.time}
                                      </td>
                                      <td className="p-3 sm:p-4 leading-relaxed">{item.visual}</td>
                                      <td className="p-3 sm:p-4 leading-relaxed text-slate-700 dark:text-slate-300">
                                        {item.audio}
                                      </td>
                                      <td className="p-3 sm:p-4 leading-relaxed text-emerald-700 dark:text-emerald-300 font-semibold">
                                        {item.text_on_screen}
                                      </td>
                                    </tr>
                                  ))}
                          ...
                          <div className="p-8 text-center text-slate-500 dark:text-slate-400 bg-slate-100/50 dark:bg-slate-900/50 rounded-2xl border border-slate-200 dark:border-slate-800">
                  ...
                  {activeTab === "caption" && (
                    <div className="space-y-4">
                      {!isProOrAdmin ? (
                        <div className="relative rounded-2xl overflow-hidden border border-amber-500/30 bg-white/90 dark:bg-slate-950/90 p-6 space-y-4">
                          {/* Lock Banner Overlay */}
                          <div className="absolute inset-0 z-20 flex flex-col items-center justify-center p-6 bg-white/85 dark:bg-slate-950/85 backdrop-blur-md text-center space-y-3">
                            <div className="w-12 h-12 rounded-2xl bg-amber-500/20 text-amber-600 dark:text-amber-400 flex items-center justify-center border border-amber-500/40 shadow-lg shadow-amber-500/10">
                          ...
                          <div className="filter blur-md select-none pointer-events-none opacity-20 space-y-4">
                            <div className="space-y-1">
                              ...
                              <p className="p-3 rounded-xl bg-slate-100 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 leading-relaxed">
                            ...
                            <div className="space-y-1">
                              ...
                              <p className="p-3 rounded-xl bg-slate-100 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 font-mono text-xs">
                            ...
                            <div className="space-y-1">
                              ...
                              <p className="p-3 rounded-xl bg-slate-100 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-xs">
                        ...
                        <div className="space-y-4">
                          <div className="p-5 rounded-2xl bg-white/90 dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 space-y-4 text-sm text-slate-800 dark:text-slate-200">
                            <div className="space-y-1">
                              <h4 className="text-xs font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-wide flex items-center space-x-1.5">
                                <Pin className="w-3.5 h-3.5 text-emerald-600 dark:text-emerald-400" />
                                <span>แคปชันสำหรับโพสต์คลิป (Caption)</span>
                              </h4>
                              <p className="p-3 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800/80 leading-relaxed text-slate-800 dark:text-slate-200">
                                {caption || `รีวิว ${productName} คุ้มค่าตอบโจทย์ชัวร์!`}
                              </p>
                            </div>

                            <div className="space-y-1">
                              <h4 className="text-xs font-bold text-purple-600 dark:text-purple-400 uppercase tracking-wide flex items-center space-x-1.5">
                                <Hash className="w-3.5 h-3.5 text-purple-600 dark:text-purple-400" />
                                <span>แฮชแท็กดันฟีดติดเทรนด์ (Hashtags)</span>
                              </h4>
                              <p className="p-3 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800/80 font-mono text-purple-700 dark:text-purple-300 text-xs">
                            ...
                            <div className="space-y-1">
                              ...
                              <p className="p-3 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800/80 text-amber-800 dark:text-amber-200 text-xs">
            ...
            /* Empty State / Ready Preview Card when generatedScript is null */
            <div className="bg-white/70 dark:bg-slate-950/80 backdrop-blur-xl border border-slate-200/80 dark:border-slate-800/80 shadow-xl dark:shadow-2xl rounded-2xl sm:rounded-3xl p-6 sm:p-8 text-center flex flex-col items-center justify-center min-h-[480px] space-y-6">
              <div className="w-16 h-16 rounded-3xl bg-gradient-to-tr from-purple-600 via-indigo-600 to-pink-500 flex items-center justify-center text-white shadow-xl shadow-purple-500/30 ring-4 ring-purple-400/20">
                <Sparkles className="w-8 h-8 text-white animate-pulse" />
              </div>

              <div className="space-y-2 max-w-md">
                <h3 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-slate-100">
                  พร้อมสร้างสคริปต์รีวิวระดับมืออาชีพ
                </h3>
                <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                  กรอกชื่อสินค้าและเลือกโทนการเล่าเรื่องในฝั่งซ้าย จากนั้นกด <strong className="text-purple-600 dark:text-purple-300">"สร้างสคริปต์รีวิวสินค้า"</strong> เพื่อรับผลลัพธ์ทันที!
                </p>
              </div>

              {/* Feature Highlights Grid */}
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 w-full max-w-lg text-left pt-2">
                <div className="p-3.5 rounded-2xl bg-white/80 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 space-y-1 shadow-sm">
                  <div className="text-xs font-bold text-purple-700 dark:text-purple-300 flex items-center space-x-1.5">
                    <FileText className="w-3.5 h-3.5 text-purple-500 shrink-0" />
                    <span>3 Hook Options</span>
                  </div>
                  <p className="text-[11px] text-slate-500 dark:text-slate-400 leading-tight">
                    หยุดสายตาใน 3 วินาทีแรกด้วยคำเปิด 3 สไตล์
                  </p>
                </div>
                ...
                <div className="p-3.5 rounded-2xl bg-white/80 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 space-y-1 shadow-sm">
                  ...
                  <p className="text-[11px] text-slate-500 dark:text-slate-400 leading-tight">
                    วางแผน Shot-by-Shot ซับกลางจอ & คำพูด
                  </p>
                </div>

                <div className="p-3.5 rounded-2xl bg-white/80 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 space-y-1 shadow-sm">
                  <div className="text-xs font-bold text-pink-700 dark:text-pink-300 flex items-center space-x-1.5">
                    <Video className="w-3.5 h-3.5 text-pink-500 shrink-0" />
                    <span>Teleprompter</span>
                  </div>
                  <p className="text-[11px] text-slate-500 dark:text-slate-400 leading-tight">
                    เครื่องอ่านบทลอยตัว อ่านขณะอัดคลิป TikTok
                  </p>
                </div>
              </div>
            </div>
